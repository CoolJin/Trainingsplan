...
export const GlareCard = ({
    ...
    return (
        <div
            ...
            ref={refElement}
            onPointerMove={(event) => {
                // Changed rotateFactor from 0.4 to 0.8 for increased rotation effect
