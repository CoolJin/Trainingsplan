...
export const GlareCard = ({
    ...
    const backgroundStyle = {
        ...
        // GRAYSCALE RAINBOW (White/SilverShimmer)
        "--rainbow":
        ...
        "--diagonal":
            "repeating-linear-gradient( 128deg,#0e152e 0%,hsl(0,0%,60%) 3.8%,hsl(0,0%,60%) 4.5%,hsl(0,0%,60%) 5.2%,#0e152e 10%,#0e152e 12% ) var(--bg-x) var(--bg-y)/300% no-repeat",
        "--shade":
